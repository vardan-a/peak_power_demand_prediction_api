...
# Average CV score on the training set was: -718661.8703049561
exported_pipeline = DecisionTreeRegressor(max_depth=10, min_samples_leaf=10, min_samples_split=16)
